     ...
     <section class="ftco-section-2">
      <div class="container d-flex">
        <div class="section-2-blocks-wrapper row">
          <div class="img col-sm-12 col-lg-6" style="background-image: url('images/Rendang.jpg');">
          </div>
          <div class="text col-lg-6 ftco-animate">
            <div class="text-inner align-self-start">
              <span class="subheading">Promo Minggu Ini</span>
              <h3 class="heading">Rendang Khas Padang</h3>
              <p>Rendang atau randang adalah masakan daging bercita rasa pedas yang menggunakan berbagai bumbu dan rempah-rempah. Masakan ini dihasilkan dari proses memasak yang dipanaskan berulang-ulang dengan santan kelapa.</p>

              <p>Restoran kami menggunakan daging sapi lokal dan bumbu rempah-rempah yang berkualitas, sehingga menciptakan cita rasa berciri khas Indonesia</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row d-flex no-gutters">
          <div class="col-lg-6">
            <div class="block-3 d-md-flex ftco-animate">
              <div class="image order-last" style="background-image: url(images/Tempe.jpg);"></div>
              <div class="text text-center order-first">
                <h2 class="heading">Tempe</h2>
                <p>Tempe merupakan makanan fermentasi kedelai yang di setiap rumah tangga ada, bahkan bisa jadi makanan pokok keluarga di Indonesia</p>
                <span class="price">from Rp.15.000</span>
              </div>
            </div>
            <div class="block-3 d-md-flex ftco-animate">
              <div class="image order-first" style="background-image: url(images/Semur-Jengkol.jpg);"></div>
              <div class="text text-center order-first">
                <h2 class="heading">Semur Jengkol</h2>
                <p>Jengkol yang terkenal dengan baunya yang tidak sedap, tapi rasanya enak banget. Yakni semur jengkol yang rasanya sangat sedap</p>
                <span class="price">from Rp. 23.000</span>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="block-3 d-md-flex ftco-animate">
              <div class="image order-last" style="background-image: url(images/Siomay.jpg);"></div>
              <div class="text text-center order-first">
                <h2 class="heading">Siomay</h2>
                <p>Makanan ringan yang mirip dengan Dim Sum. Pangsit kukus yang diisi dengan sayuran dan daging ikan tenggiri yang disajikan dengan saus kacang</p>
                <span class="price">from Rp. 15.000</span>
              </div>
            </div>
            <div class="block-3 d-md-flex ftco-animate">
              <div class="image order-first" style="background-image: url(images/Seblak.jpg);"></div>
              <div class="text text-center order-first">
                <h2 class="heading">Seblak Pedas</h2>
                <p>Seblak yang dibuat dari beberapa bahan seperti sayur, mie, makaroni, kerupuk basah dan perpaduan rempah khas Indonesia</p>
                <span class="price">from Rp 10.000</span>
              </div>
            </div>
          </div>
        </div>
